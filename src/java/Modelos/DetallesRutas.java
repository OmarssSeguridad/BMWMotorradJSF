...
@NamedQueries({
    ...
    , @NamedQuery(name = "DetallesRutas.findByCreatedAt", query = "SELECT d FROM DetallesRutas d WHERE d.createdAt = :createdAt")
    , @NamedQuery(name = "DetallesRutas.findByUpdatedAt", query = "SELECT d FROM DetallesRutas d WHERE d.updatedAt = :updatedAt")})
