...
@NamedQueries({
    ...
    , @NamedQuery(name = "DetallesPagos.findByCreatedAt", query = "SELECT d FROM DetallesPagos d WHERE d.createdAt = :createdAt")
    , @NamedQuery(name = "DetallesPagos.findByUpdatedAt", query = "SELECT d FROM DetallesPagos d WHERE d.updatedAt = :updatedAt")})
